...
import { avatarsSnippets } from '../snippets/avatars';
    ...
    return (
        <div className="space-y-8">
            ...
            <ComponentShowcase
                ...
                code={avatarsSnippets.withStatus}
            />
