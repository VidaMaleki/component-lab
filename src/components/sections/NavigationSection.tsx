      ...
      <ComponentShowcase
        ...
        preview={
          <div className="relative inline-block">
            <button onClick={() => setOpen(!open)} className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 rounded-lg hover:bg-slate-50">
              Options
              <ChevronDown className="w-4 h-4" />
            </button>
            {open && (
              <div className=" bg-white border border-slate-200 rounded-lg shadow-lg ">                            <a href="#" className="block px-4 py-2 text-slate-700 hover:bg-slate-100">Profile</a>
