    ...
    return (
        <div className="space-y-8">
            ...
            <ComponentShowcase
                ...
                code={`import { ShoppingCart, Heart, Star } from 'lucide-react';
      ...
      <button className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm">
        ...
        Add to Cart
            ...
            <ComponentShowcase
                ...
                preview={
                    <>
                        <div className="w-72 bg-white border border-slate-200 rounded-xl p-6">
                        ...
                        <div className="w-72 bg-gradient-to-br from-indigo-600 to-purple-600 text-white rounded-xl p-6">
  ...
  <p className="text-sm text-slate-600">
    Track your website performance with live data updates and detailed insights.
            ...
            <ComponentShowcase
                ...
                code={`<div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
  <div className="h-24 bg-gradient-to-r from-indigo-500 to-purple-500"></div>
  <div className="px-6 pb-6">
    <div className="flex items-end gap-4 -mt-12 mb-4">
  ...
  <div className="flex items-center gap-1 text-sm">
    ...
    <span className="text-slate-600">from last month</span>
            ...
            <ComponentShowcase
                ...
                code={`<div className="bg-white border border-slate-200 rounded-xl overflow-hidden flex">
